...
from .shared_utils import InstrDict, read_extension_file
...
def make_llvm_csrs():
    """Generate LLVM TableGen CSR definitions from riscv-opcodes csrs.csv."""
    lines = [
        "// Auto-generated by riscv_opcodes. DO NOT EDIT.",
        "",
    ]

    for num, name in sorted(csrs, key=lambda item: item[0]):
...
def make_llvm(instr_dict: InstrDict, extensions: Sequence[str]):
